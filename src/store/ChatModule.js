...
const ChatModule = {
    state: {
        ...
        selectedFriend: null,
        selectedGroup: null,
        emojis:emojiObj.peoples.people,
    },
    mutations: {
    ...
    actions: {
        doSelectFriend({commit}, friend) {
            commit("setSelectedFriend", friend)
            commit("setSelectedGroup", null)

        },
        doSelectGroup({commit}, group) {
            commit("setSelectedGroup", group)
            commit("setSelectedFriend", null)
        },
    },
    getters: {
        emojis(state) {
        ...
        chatBoxTitle(state){
            if (state.selectedFriend){
                return "好友:"+state.selectedFriend.name
            }
            if (state.selectedGroup){
                return "群聊:"+state.selectedGroup.name
            }
            return ""
        },
    }
